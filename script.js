...
$(function() {
    $(function() {
        ...
        $(window).load(function() {
            ...
            if(_userdata.user_level == 1 0 && _userdata.user_level == 2) $(".sceditor-group:last-child").before('<div class="sceditor-group"><a class="sceditor-button sceditor-button-staff" title="Mesaje de moderare"><div unselectable="on">Mesaje de moderare</div></a><div class="mod_box" style="display: none;"><ul class="mod_groups" id="mod_box_i">' + list + '<li class="copyright_e"> © Created by Zeus - All right reserved</li></div></div></div>');
        });
    });
});
